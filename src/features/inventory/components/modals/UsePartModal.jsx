...
function UsePartModal({
  ...
  return (
    <Modal
      isOpen={isOpen}
      title="Use Part"
      description="Subtract a part from your truck inventory and save the job history."
      onClose={onClose}
      footer={
        <>
          ...
          <Button type="submit" form="use-part-form">
            Save Use
          </Button>
        </>
      }
    >
      <form id="use-part-form" className="inventory-form" onSubmit={handleSubmit}>
        {errorMessage && (
        ...
        <Input
          ...
          list="use-part-location-options"
          required
        />

        <datalist id="use-part-location-options">
